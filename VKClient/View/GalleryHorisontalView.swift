...
class GalleryHorisontalView: UIView {
    ...
    private func loadFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "GalleryHorisontalView", bundle: bundle)
    ...
    func setImages(images: [UIImage], showIndexPhoto: Int) {
        self.images = images
        self.currentIndex = showIndexPhoto
        
        if self.images.count > 0 {
            self.mainImageView.image = self.images[showIndexPhoto]
        }
    }
}
